...
import { useBannerMutations } from "@/app/lib/hooks/useBanners";
...
const Page = () => {
  ...
  const { createBanner, loading } = useBannerMutations();
  ...
  return (
    <div className="mt-3 animate-fadeIn">
      <PageHeader
        ...
        description="Create a new advertising banner"
        breadcrumbs={[
                  ...
                  >
                    {imagePreview ? (
                      ...
                      <div className="flex flex-col items-center justify-center pt-5 pb-6">
                        ...
                        <p className="text-xs text-body mt-1">PNG, JPG or WEBP (MAX. 2MB)</p>
                      </div>
                    )}
                    <input
                      id="image"
