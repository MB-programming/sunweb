...
const Page = () => {
  ...
  return (
    <div >
      <h3 className="text-white text-[1.3rem] font-semibold">Add new ticket</h3>
          ...
          <div className="flex justify-start mt-4 gap-3 flex-col">
            ...
            <label htmlFor="title" className="text-white text-base mt-4 inline-block">
            Attachments
            </label>
            ...
            <div className="flex items-center mt-4 gap-3">
              <button className='bg-main text-black text-[0.9rem] flex-1 border border-main text-center p-2 rounded'>Submit tickt</button>
              <button className=' text-[0.9rem] text-white py-2 px-14 border border-white rounded'>Cancel</button>
            </div>
          </form>
    </div>
  );
